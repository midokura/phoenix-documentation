...
In these release we need to migrate the management cluster network to the new subnet 10.32.0.0/16. Please, follow the runbook [MGMT_CLUSTER_SUBNET_MIGRATION](./service-operator/runbooks/MGMT_CLUSTER_SUBNET_MIGRATION.md) during or after the update to this version.
