...
- **IaaS Console and observability ingresses** (`console.*`). These run in the management cluster and are issued by cert-manager against Let'Encrypt. Cert-manager renews them automatically ~30 days before expiry.
